...
project = u'Jiffle'
copyright = u'2011, Michael Bedward'
...
latex_documents = [
  ('index', 'Jiffle.tex', u'Jiffle Documentation',
   u'Michael Bedward', 'manual'),
]
...
man_pages = [
    ('index', 'jiffle', u'Jiffle Documentation',
     [u'Michael Bedward'], 1)
]
