...
.. literalinclude:: /../src/main/resources/jaitools/jiffle/docs/MeanFilterDynamic.jfl 
...
passed to a JAI-tools **JiffleOpImage**  for execution as part of an image rendering chain. In that case, the value of n
